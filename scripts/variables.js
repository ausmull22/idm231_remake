...
function zodiac_aries() { // Switch to Aries
    ...
    document.getElementById("js-cereal-view").alt = "Lucky Charms"; // Cereal Alt Text to "Lucky Charms"
...
function zodiac_cancer() { // Switch to Cancer
    ...
    document.getElementById("js-cereal-view").alt = "Frosted Flakes"; // Cereal Alt Text to "Frosted Flakes"
